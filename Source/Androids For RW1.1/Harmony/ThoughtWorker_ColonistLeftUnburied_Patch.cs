...
namespace MOARANDROIDS
{
...

    {
        ...
        public class CurrentStateInternal_Patch
        {
            ...
            {
                if (Utils.ExceptionAndroidListBasic.Contains(p.def.defName) || Utils.pawnCurrentlyControlRemoteSurrogate(p) ||
                    p.story != null && p.story.traits.HasTrait(Utils.traitSimpleMinded)) __result = ThoughtState.Inactive;
            }
        }
    }
}